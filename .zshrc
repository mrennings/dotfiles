...
plugins=(git ssh-agent zsh-syntax-highlighting zsh-autosuggestions gpg-agent aws wakatime timewarrior terraform)
...
bindkey -e
bindkey "^[q"   push-line-or-edit                   ### <ESC>-<q>
...
zstyle ':completion:*:*:sudo:*' command-path /sbin /usr/sbin /usr/local/sbin $path
